...
def test_stripe_notification_model_preserves_database_indexes() -> None:
    ...
    assert {index.name for index in table.indexes} == {
        "idx_stripenotification_eventid",
        "idx_stripenotification_invoiceid",
        "idx_stripenotification_customerid",
        "idx_stripenotification_userid",
        "idx_stripenotification_createdate",
    }
