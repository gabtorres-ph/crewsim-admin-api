...
class StripeNotification(Base):
    ...
    __table_args__ = (
        Index("idx_stripenotification_eventid", "eventid"),
        Index("idx_stripenotification_invoiceid", "invoiceid"),
        Index("idx_stripenotification_customerid", "customerid"),
        Index("idx_stripenotification_userid", "userid"),
        Index("idx_stripenotification_createdate", "createdate"),
    )
